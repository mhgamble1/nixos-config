...
| `ne`          | Edit `hosts/desktop/default.nix`        |
| `nfl`         | Edit `flake.nix`                        |
...
| `sudo nixos-rebuild switch --flake /etc/nixos`       | Same, explicit                   |
| `sudo nixos-rebuild boot --flake /etc/nixos`         | Apply on next boot only          |
| `sudo nixos-rebuild dry-run --flake /etc/nixos`      | Preview without applying         |
...
| File                                        | Purpose                                    |
|---------------------------------------------|--------------------------------------------|
| `/etc/nixos/flake.nix`                      | Entry point — nixpkgs pin, host outputs    |
| `/etc/nixos/hosts/desktop/default.nix`      | Desktop: boot, GPU, NAS, Ollama            |
| `/etc/nixos/modules/nixos/`                 | Shared system modules                      |
| `/etc/nixos/home/mhg/default.nix`           | Home Manager root                          |
